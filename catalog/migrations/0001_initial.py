# Generated by Django 4.0 on 2022-05-05 12:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(help_text='Enter the author of the book.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.author')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter the book genre (fiction, non-fiction, science, science fiction, etc)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Language',
